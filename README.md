...
- визуально настраивать компактную shell-палитру из 13 основных цветов;
...
В панели доступны 13 основных значений: четыре поверхности, два цвета текста,
две точки акцентного градиента, контрастный акцент, одна граница и три статуса.
Glass/soft surfaces, strong border, ghost text, карточки, hover-ссылки, timeline,
expiration и disabled-кнопки рассчитываются автоматически. Старые CSS-переменные
